...
- [ ] Grow Swift Steward from read-heavy guidance-sync and repo-maintenance scans into reviewable draft patch output, then decide whether any apply-mode behavior belongs in the main thread, a guarded report workflow, or a future repo-local sidecar.
