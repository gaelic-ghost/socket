...
- `server-side-swift`: server-side Swift, Vapor, Hummingbird, persistence, OpenAPI, RPC-fit, Docker, and Apple Containerization workflows with SwiftPM-first build, run, test, framework-specific migration, database, generated transport, container, and diagnostics guidance
