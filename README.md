...
- `reverse-engineering-skills`: binary inspection, artifact triage, preservation, exact-build comparison, decompiler review, Apple bundle and Mach-O inspection, Swift and Objective-C runtime recovery, symbol and crash correlation, signing and containment auditing, Apple Silicon analysis, and reproducible evidence workflows
