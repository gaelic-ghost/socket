...
- `reverse-engineering-skills`: binary inspection, artifact triage, analysis-path selection, preservation, exact-build comparison, decompiler-output review, and reproducible evidence workflows
