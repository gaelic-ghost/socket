...
- Keep `rust-skills` as a small, honest placeholder repository until the first real Rust-focused skill is ready to ship.
...
- [ ] Milestone 1: first exported Rust skill
...
- [ ] The repository ships at least one real Rust-focused skill.
