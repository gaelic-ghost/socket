...
- Treat `repository-skills` as the default baseline maintainer layer for general repo-doc and maintenance work; use this repo when Rust, Cargo, rustup, crate, workspace, package, test, lint, or formatting behavior should materially change the workflow.
