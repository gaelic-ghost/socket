...
description: Parse, inspect, generate, or transform Swift source with SwiftParser, SwiftSyntax, SwiftSyntaxBuilder, visitors, rewriters, and diagnostics while preserving source fidelity. Use for codemods, structural linting, generators, syntax-aware edits, or macro implementation trees that do not require inferred semantic types.
license: Apache-2.0
metadata:
  owner: gaelic-ghost
  repo: socket
