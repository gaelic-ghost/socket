...
description: Configure, integrate, inspect, or diagnose SourceKit-LSP for Swift and C-family projects across SwiftPM, compilation databases, and build servers. Use for completion, navigation, refactoring, diagnostics, semantic tokens, indexing, generated files, editor clients, or language-server failures.
license: Apache-2.0
metadata:
  owner: gaelic-ghost
  repo: socket
