...
Use this document when an Agent Engineering skill needs to explain or audit
OpenAI Codex Hooks without turning hooks into a default requirement for every
repository.
