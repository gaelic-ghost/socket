...
1. CLI flags
2. `--config` file
3. Repo profile: `.codex/profiles/bootstrap-python-service/customization.yaml`
4. Global profile: `~/.config/gaelic-ghost/python-skills/bootstrap-python-service/customization.yaml`
5. Script defaults
