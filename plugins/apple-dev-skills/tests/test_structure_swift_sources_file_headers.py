...
class StructureSwiftSourcesFileHeaderTests(unittest.TestCase):
    ...
    def test_apply_inventory_replaces_existing_structured_header(self) -> None:
            ...
            inventory.write_text(
                "\n".join(
                    [
                        ...
                        '    see_also: "GEAFeatureService.swift, GEAFeatureViewModifier.swift"',
                    ]
                )
                + "\n",
                encoding="utf-8",
        ...
        self.assertIn("See Also: GEAFeatureService.swift, GEAFeatureViewModifier.swift", rewritten)
    ...
    def test_checked_in_inventory_template_matches_loader_contract(self) -> None:
        ...
        self.assertEqual(
            entries[0]["see_also"],
            ["GEAFeatureService.swift", "GEAFeatureViewModifier.swift"],
        )
