...
require_contains "AGENTS.md" 'Treat `repository-skills` as the default baseline maintainer layer'
...
active_skill_mds=(
  ...
  "./skills/vision-image-analysis-workflow/SKILL.md"
  "./skills/vision-coreml-recognition-workflow/SKILL.md"
  "./skills/camera-capture-depth-workflow/SKILL.md"
  ...
  "./skills/app-intents-workflow/SKILL.md"
  "./skills/ios-runtime-forensics-workflow/SKILL.md"
  "./skills/macos-distribution-workflow/SKILL.md"
  "./skills/swiftui-app-architecture-workflow/SKILL.md"
  "./skills/swiftui-component-audit-workflow/SKILL.md"
...
require_contains "$dash_skill_dir/SKILL.md" 'Prefer direct docs access methods in this order: Xcode MCP `DocumentationSearch` first, Dash.app MCP second, Dash localhost HTTP only when the Dash.app MCP is unavailable or incomplete, then checked-out source, generated DocC, GitHub/source repositories, or release notes, and finally readable online documentation.'
