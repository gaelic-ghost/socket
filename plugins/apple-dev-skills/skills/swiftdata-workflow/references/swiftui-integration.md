...
- A paired `GEAWhateverViewModel` may drive presentation state for `GEAWhateverView`, but it must not mirror or cache SwiftData merely to avoid the framework's direct integration.
