...
description: Guide tvOS media playback decisions for AVKit system-player adoption, custom-player escalation, remote transport commands, Now Playing state, HLS/interstitial features, and device-aware validation. Use when Apple TV playback and remote-control responsibility are primary.
---
