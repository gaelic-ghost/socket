...
Use the Xcode-side Apple documentation first when the question is about the product-integrated DocC workflow:
...
These are the best first stop for:

- where DocC fits into Xcode
