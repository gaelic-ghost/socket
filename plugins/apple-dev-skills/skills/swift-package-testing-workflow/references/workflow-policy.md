...
3. Use SwiftPM for package tests regardless of co-located Xcode files.
4. Hand off to `xcode-testing-workflow` only for `.xctestplan`, XCUITest, scheme, or destination operations, and use `xcode-build-run-workflow` for guarded Xcode project-integrity work.
