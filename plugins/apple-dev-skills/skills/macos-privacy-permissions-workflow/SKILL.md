...
description: Diagnose and implement macOS app-facing privacy permissions, including Accessibility, Automation and Apple Events, Developer Tools, screen and system-audio recording, Input Monitoring, protected personal data, Files and Folders, Full Disk Access, App Management, and managed PPPC policy. Use when a Mac app, helper, XPC service, command-line tool, IDE, terminal, or agent host cannot perform a protected operation or needs a correct preflight, request, denial, Settings, reset, and retry lifecycle.
---
