...
- The active skill surface ships `43` separate `references/customization.template.yaml` files.
- The active skill surface ships `43` separate `scripts/customization_config.py` entrypoints.
