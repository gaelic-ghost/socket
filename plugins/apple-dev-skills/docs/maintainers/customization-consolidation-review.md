...
- The active skill surface ships `39` separate `references/customization.template.yaml` files.
- The active skill surface ships `39` separate `scripts/customization_config.py` entrypoints.
