...
- The active skill surface ships `36` separate `references/customization.template.yaml` files.
- The active skill surface ships `36` separate `scripts/customization_config.py` entrypoints.
