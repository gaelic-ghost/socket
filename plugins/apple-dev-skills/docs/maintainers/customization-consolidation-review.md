...
- The active skill surface ships `60` separate `references/customization.template.yaml` files.
- The active skill surface ships `60` separate `scripts/customization_config.py` entrypoints.
