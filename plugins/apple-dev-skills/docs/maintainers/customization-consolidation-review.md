...
- The active skill surface ships `28` separate `references/customization.template.yaml` files.
- The active skill surface ships `28` separate `scripts/customization_config.py` entrypoints.
