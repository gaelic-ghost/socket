...
- The active skill surface ships `34` separate `references/customization.template.yaml` files.
- The active skill surface ships `34` separate `scripts/customization_config.py` entrypoints.
