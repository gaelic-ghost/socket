...
- The active skill surface ships `59` separate `references/customization.template.yaml` files.
- The active skill surface ships `59` separate `scripts/customization_config.py` entrypoints.
