...
- The active skill surface ships `29` separate `references/customization.template.yaml` files.
- The active skill surface ships `29` separate `scripts/customization_config.py` entrypoints.
