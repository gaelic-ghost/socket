...
- The active skill surface ships `42` separate `references/customization.template.yaml` files.
- The active skill surface ships `42` separate `scripts/customization_config.py` entrypoints.
