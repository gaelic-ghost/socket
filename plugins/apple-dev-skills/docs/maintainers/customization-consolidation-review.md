...
- The active skill surface ships `26` separate `references/customization.template.yaml` files.
- The active skill surface ships `26` separate `scripts/customization_config.py` entrypoints.
