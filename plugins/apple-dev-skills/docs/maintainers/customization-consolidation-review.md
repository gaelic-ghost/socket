...
- The active skill surface ships `38` separate `references/customization.template.yaml` files.
- The active skill surface ships `38` separate `scripts/customization_config.py` entrypoints.
