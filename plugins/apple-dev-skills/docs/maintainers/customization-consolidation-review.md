...
- The active skill surface ships `41` separate `references/customization.template.yaml` files.
- The active skill surface ships `41` separate `scripts/customization_config.py` entrypoints.
