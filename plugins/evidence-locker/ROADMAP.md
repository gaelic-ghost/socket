...
- Keep `evidence-locker` as a small, honest placeholder repository until the first real evidence-focused Codex workflow is ready to ship.

## Product Principles

- Keep the repository minimal until there is a real exported evidence surface.
...
- [ ] Milestone 1: first exported evidence workflow
...
- Author the first real evidence-focused Codex workflow for this repository.

Tickets:

- [ ] Add the first maintained evidence skill, app, or MCP-backed workflow under the canonical exported surface.
- [ ] Update root docs to describe the real shipped behavior instead of the placeholder state.

Exit criteria:

- [ ] The repository ships at least one real evidence-focused workflow.
...
- [ ] Add the minimum validation or smoke coverage needed for the shipped evidence surface.
