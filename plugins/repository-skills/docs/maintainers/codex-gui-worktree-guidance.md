...
Use this maintainer note when updating `repository-skills:codex-gui-worktree-workflow`.
...
- `repository-skills` owns general Codex GUI workflow choice and repo guidance shape.
