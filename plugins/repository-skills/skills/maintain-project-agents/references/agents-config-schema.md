...
The AGENTS configuration file is YAML and uses this top-level shape:
...
- `requiredSections` defines the canonical top-level sections, excluding the title and preamble.
