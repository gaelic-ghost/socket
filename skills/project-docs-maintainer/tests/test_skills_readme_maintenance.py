...
def _load_module():
    module_path = Path(__file__).resolve().parents[1] / "scripts" / "skills_readme_maintenance.py"
    spec = importlib.util.spec_from_file_location("skills_readme_maintenance", module_path)
