...
# ///
"""Load and persist sandbox file-access workflow customization state."""
...
SKILL_NAME = "macos-sandbox-file-access-workflow"
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Manage sandbox file-access customization")
