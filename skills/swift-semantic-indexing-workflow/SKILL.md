...
description: Query Swift types, USRs, documentation, occurrences, references, and relationships with SourceKit, SourceKitten, index stores, and IndexStoreDB. Use for file-local semantics or project-wide symbol questions.
license: Apache-2.0
metadata:
  owner: gaelic-ghost
  repo: socket
