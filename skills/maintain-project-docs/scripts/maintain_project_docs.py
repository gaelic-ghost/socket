...
def select_workflows(
    include: Optional[str], skip: Optional[str], project_root: Optional[Path] = None
) -> Tuple[List[DocumentWorkflow], List[str]]:
...
def run_maintenance(args: argparse.Namespace) -> Tuple[Dict[str, Any], str]:
    ...
    selected, selection_errors = select_workflows(args.include, args.skip, project_root)
    report: Dict[str, Any] = {
        "run_context": {
